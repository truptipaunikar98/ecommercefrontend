  ...
  return (
    <div className="row p-sm-3  p-md-5 text-center bg-dark text-white">
      <div className="col-md-3 col-sm-12 p-3  " >
        ...
        <Link to="/menswear">Mens</Link>
        <Link to="/womenswear">Womens</Link>
        </div>
        <div className="d-flex justify-content-around">
      ...
      <div className="col-md-3 col-sm-12 p-3 " >
        <h6>Follow Us</h6>
         <img className="logoHeight m-2" src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Instagram_logo_2016.svg/2048px-Instagram_logo_2016.svg.png"></img>
         <img className="logoHeight m-2" src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Instagram_logo_2016.svg/2048px-Instagram_logo_2016.svg.png"></img>
      </div>
      <div className="col-md-3 col-sm-12 p-3">
        <h6>Contact Us</h6>
